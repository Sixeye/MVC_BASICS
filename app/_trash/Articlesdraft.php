<?php
    ...
    */
        ...
        static function createArticles()
        {
            ...
            if (isset($_POST['create_post'])){
                ...
                $reqArticles = $conn->prepare('INSERT INTO articles(title, sentence, content, date, author_id, category_id) VALUES(?, ?, ?, ?, ?, ?)');
    ...
    */
        ...
        static function fillArticles()
        {
            ...
            if (isset($_POST['update'])){
                $id = (int)($_POST['update']);
                $reqArticles = $conn->prepare("SELECT * FROM articles WHERE id = $id");
                $reqArticles->execute();
    ...
    */
        ...
        static function updateArticles(){
                ...
                $udArticles = $conn->prepare('UPDATE articles set title = ?, sentence = ?, content = ?, date = ?, author_id = ?, category_id = ? WHERE id = ?');
